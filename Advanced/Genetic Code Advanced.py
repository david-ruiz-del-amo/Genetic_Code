...
parser = argparse.ArgumentParser(description="This is a basic project which principal purpose is to translate sequences")
parser.add_argument("--nnaa", type=str, required=True, choices=("DNA", "RNA"),
                    help="Introduce whichever nucleic acid you want to analyze (DNA or RNA)")
parser.add_argument("--fasta", type=str, required=True,
                    help="Introduce the path to the FASTA file which you want to process")
nucleic_acid = parser.parse_args().nnaa
